        ...
        <div className="container pb-5">
          <div className="row">
            <div className="col-md-6">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title bg-primary px-4 py-4 text-light">Recent blogs by {user.name}</h5>
                  <br />
                  <p>{showUserBlogs()}</p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title bg-primary px-4 py-4 text-light">Message {user.name}</h5>
                  <br />
